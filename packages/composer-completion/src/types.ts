...
export type CompletionFrame =
  | { readonly type: 'update'; readonly context: CompletionContext; readonly text: string }
  | { readonly type: 'done'; readonly context: CompletionContext; readonly text: string }
